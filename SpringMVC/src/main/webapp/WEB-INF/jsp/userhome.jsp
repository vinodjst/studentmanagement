...
<ul>
  ...
  <li><a href="${pageContext.request.contextPath}/fetchstudentbyname/${sessionScope.loguser}" >Profile</a></li>
...
<p>Welcome <span style="font-size:22px;color:blue;"><i>${sessionScope.loguser}</i>!</span></p>
